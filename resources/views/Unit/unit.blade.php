...
<!--           <ul class="treeview-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=" {{url('/inputPpbj')}} "><i class="fa fa-circle-o"></i> BPPJ</a></li>
          </ul>
        </li>
        <li>
          <a href=" {{'/allPpbj'}} ">
            <i class="fa fa-th"></i> <span>Lihat Data PPBJ</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('addUnit')}}"><i class="fa fa-circle-o"></i> Tambah Unit Kerja</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Lihat Unit Kerja</a></li>            <li><a href="#"><i class="fa fa-circle-o"></i> Level One</a></li>
          </ul>
        </li>
