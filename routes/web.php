...
Route::get('/assignmentPpbj/{id}', 'PegawaiController@editassignmentPpbj')->name('editassignmentPpbj');
Route::post('/assignmentPpbj/', 'PegawaiController@updateassignmentPpbj')->name('updateassignmentPpbj');